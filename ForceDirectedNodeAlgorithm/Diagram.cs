...
/*
 Added ForceDirectedAlgorithm namespace.
 Added ElapsedGenerationMilliseconds and ElapsedGenerationTicks properties.
 Added MinimumDisplacement property.
 Added a custom Arrange() method that takes seed and minimumDisplacement values and tracks generation statistics.
 Added drawing of node label.
 Changed DEFAULT_SPRING_LENGTH to 5.
 2015-04-12 by Michael Derenardi
*/
...
namespace ForceDirectedAlgorithm
{
    /// <summary>
    ...
    public class Diagram
    {
        ...
        private const int DEFAULT_SPRING_LENGTH = 5;
        ...
        public void Draw(Graphics graphics, Rectangle bounds)
        {
            ...
            foreach (Node node in mNodes)
            {
                ...
                graphics.DrawString(node.Label, new Font("Arial", 10), new SolidBrush(Color.Black),
                    new PointF(center.X + destination.X - (nodeSize.Width / 2) + 10, center.Y + destination.Y - (nodeSize.Height / 2)));
            }
        }
